...
//
//import base_classes.Company;
//import base_classes.Coupon;
//
...
//					Company., Company.getCompanyEmail(), Company.getCompanyPassword());
//
//			try (PreparedStatement preparedStatement = connection.prepareStatement(sql,
...
//					company.getCompanyName(), company.getCompanyEmail(), company.getCompanyPassword(), company.getId());
//
//			try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
//				preparedStatement.executeUpdate();
//			}
